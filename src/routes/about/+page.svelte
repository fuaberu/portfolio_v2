<div class="h-full md:flex md:gap-6">
	...
	<div class="flex w-full flex-col gap-3 md:flex-[2] max-w-md md:max-w-full mx-auto">
		...
		<p>
			...
			started a journey that led me to work as a full-time software engineer, in the company I'm
			currently at. Today, my main focus is to continuasly improve my skills and build the best
			experience for the users of my applications.
		</p>
		<p>
			I am excited about creating things that live on the internet and am always eager to take on
			new challenges. Let's connect and create something amazing together!
		</p>
	</div>
</div>
